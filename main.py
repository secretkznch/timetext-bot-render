...
SCHEDULES = {
    ...
    "pb": ["11:00", "16:30"],             # МСК:  14:00, 19:30
    "rdb": ["10:00", "15:00", "20:00"]    # МСК: 13:00, 18:00, 23:00
}
...
**По всем вопросам обращайтесь к руководству отдела <@&1095388693512065095>**""",
    ...
    "seb": {
        ...
        "content": """**Уважаемые сотрудники** {LSSD}
🔹 **Набор в отдел {SEB} открыт!** 🔹
...
**Зам начальника:** @D.Head SEB | Paradox Esser""",
    ...
    "pb": {
        "name": "Patrol Bureau",
        "content": """**Уважаемые сотрудники департамента** {LSSD}
...
По вопросам начальнику отдела @[Head PB] Dmitry_Dronov""",
    ...
    "rdb": {
        ...
        "content": """**Внимание {LSSD} !**

📚 **Отдел {RDB} открывает набор!** Вопрос в том, хватит ли у вас Желания, т.к. у нас вы не будете сидеть без дела! 
